...
#if wxOSX_USE_COCOA
WXDLLIMPEXP_CORE CGColorSpaceRef wxOSXGetMainScreenColorSpace();
#endif
...
CGImageRef WXDLLIMPEXP_CORE wxOSXCreateCGImageFromDisplay(int displayIndex = 0);
