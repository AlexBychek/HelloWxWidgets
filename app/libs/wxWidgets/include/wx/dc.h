...
public:
    ...
    virtual wxBitmap DoGetAsBitmap(const wxRect *WXUNUSED(subrect), const int& WXUNUSED(
        displayIndex)) const
        { return wxNullBitmap; }
...
public:
    ...
    wxBitmap GetAsBitmap(const wxRect *subrect = (const wxRect *) NULL, const int& displayIndex = 0) const
    {
        return m_pimpl->DoGetAsBitmap(subrect, displayIndex);
    }
