...
public:
    ...
    void DrawBitmap(ID2D1Bitmap* bmp, wxDouble x, wxDouble y, wxDouble w, wxDouble h) wxOVERRIDE;
    ...
    ID2D1Bitmap* wxD2DContext::GetGetD2DBitmap(const wxGraphicsBitmap& bmp) wxOVERRIDE;
...
ID2D1Bitmap* wxD2DContext::GetGetD2DBitmap(const wxGraphicsBitmap& bmp)
{
    ...
    return bitmapData->GetD2DBitmap();
}

void wxD2DContext::DrawBitmap(ID2D1Bitmap* bmp, wxDouble x, wxDouble y, wxDouble w, wxDouble h)
{
    if (m_composition == wxCOMPOSITION_DEST)
        return;
