...
wxBitmap wxGTKCairoDCImpl::DoGetAsBitmap(const wxRect* /*subrect*/, const int&) const
{
...
wxBitmap wxMemoryDCImpl::DoGetAsBitmap(const wxRect* subrect, const int& WXUNUSED(displayIndex)) const
{
